      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-12">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3">
            <button className="w-full sm:w-auto bg-linear-to-r from-[#FF5A36] to-[#A825E0] hover:opacity-90 text-white font-medium px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg transition duration-200 shadow-sm text-sm sm:text-base">
              Explore Technologies
            </button>

            <button className="w-full sm:w-auto bg-white border border-gray-200 hover:bg-gray-50 text-slate-700 font-medium px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg transition duration-200 text-sm sm:text-base shadow-sm">
              Learn More
            </button>
          </div>
        </div>
