  ...
  return (
    <nav className="w-full border-b border-gray-200 bg-white">
      <div className="relative mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 md:px-8">
        ...
        <div className="absolute left-1/2 -translate-x-git 55% md:static md:translate-x-0">
          <img src={logo} alt="Dev Stack" className="w-28 sm:w-32" />
        </div>

        <ul className="ml-auto hidden items-center gap-6 text-sm font-semibold text-slate-600 md:flex lg:gap-8">
          <li>
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-4 md:ml-8">
          <button className="text-xs font-semibold text-slate-600 sm:text-sm">
            Sign In
          </button>

          <button className="rounded-full bg-pink-600 px-3 py-2 text-xs font-bold text-white sm:px-5 sm:text-sm">
            Sign Up
          </button>
        </div>
      </div>
